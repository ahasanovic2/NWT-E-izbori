...
CREATE TABLE `polling_station_election` (
  ...
  PRIMARY KEY (`polling_station_id`,`election_id`),
  KEY `FKaxt6tg9lm4utp3stav0ltwc5y` (`election_id`),
  CONSTRAINT `FKaxt6tg9lm4utp3stav0ltwc5y` FOREIGN KEY (`election_id`) REFERENCES `election` (`id`),
  CONSTRAINT `FKmlqbvno7th3cb3q7mr8v204o3` FOREIGN KEY (`polling_station_id`) REFERENCES `polling_station` (`id`)
...
INSERT INTO `polling_station_election` VALUES (1,1),(2,1),(1,2),(2,2);
