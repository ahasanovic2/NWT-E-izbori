...
public class ElectionController {
    ...
    public ResponseEntity<String> getElectionsByPollingStationsId(@PathVariable Long pollingStationElectionId){
        return ResponseEntity.ok(electionService.getElectionsByPollingStationElectionId(pollingStationElectionId));
    }
}
