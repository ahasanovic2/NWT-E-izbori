...
public class ElectionService {
    ...
    public String getElectionsByPollingStationElectionId(Long pollingStationElectionId) {
        List<Election> elections = electionRepository.findByPollingStationElectionId(pollingStationElectionId);
        ObjectMapper objectMapper = new ObjectMapper();
        String json = null;
        try {
