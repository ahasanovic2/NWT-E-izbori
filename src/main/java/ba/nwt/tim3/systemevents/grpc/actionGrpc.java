...
@javax.annotation.Generated(
    ...
    comments = "Source: elections.proto")
public final class actionGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<ba.nwt.tim3.systemevents.grpc.Elections.Request,
      ba.nwt.tim3.systemevents.grpc.Elections.APIResponse> getLogActionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "logAction",
      requestType = ba.nwt.tim3.systemevents.grpc.Elections.Request.class,
      responseType = ba.nwt.tim3.systemevents.grpc.Elections.APIResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ba.nwt.tim3.systemevents.grpc.Elections.Request,
      ba.nwt.tim3.systemevents.grpc.Elections.APIResponse> getLogActionMethod() {
    io.grpc.MethodDescriptor<ba.nwt.tim3.systemevents.grpc.Elections.Request, ba.nwt.tim3.systemevents.grpc.Elections.APIResponse> getLogActionMethod;
      ...
      synchronized (actionGrpc.class) {
        if ((getLogActionMethod = actionGrpc.getLogActionMethod) == null) {
          actionGrpc.getLogActionMethod = getLogActionMethod = 
              io.grpc.MethodDescriptor.<ba.nwt.tim3.systemevents.grpc.Elections.Request, ba.nwt.tim3.systemevents.grpc.Elections.APIResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "action", "logAction"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ba.nwt.tim3.systemevents.grpc.Elections.Request.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ba.nwt.tim3.systemevents.grpc.Elections.APIResponse.getDefaultInstance()))
  ...
  public static abstract class actionImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void logAction(ba.nwt.tim3.systemevents.grpc.Elections.Request request,
        io.grpc.stub.StreamObserver<ba.nwt.tim3.systemevents.grpc.Elections.APIResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ba.nwt.tim3.systemevents.grpc.Elections.Request,
                ba.nwt.tim3.systemevents.grpc.Elections.APIResponse>(
  ...
  public static final class actionBlockingStub extends io.grpc.stub.AbstractStub<actionBlockingStub> {
    ...
    /**
     */
    public ba.nwt.tim3.systemevents.grpc.Elections.APIResponse logAction(ba.nwt.tim3.systemevents.grpc.Elections.Request request) {
  ...
  public static final class actionFutureStub extends io.grpc.stub.AbstractStub<actionFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ba.nwt.tim3.systemevents.grpc.Elections.APIResponse> logAction(
        ba.nwt.tim3.systemevents.grpc.Elections.Request request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LOG_ACTION:
          serviceImpl.logAction((ba.nwt.tim3.systemevents.grpc.Elections.Request) request,
              (io.grpc.stub.StreamObserver<ba.nwt.tim3.systemevents.grpc.Elections.APIResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class actionBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return ba.nwt.tim3.systemevents.grpc.Elections.getDescriptor();
    }
