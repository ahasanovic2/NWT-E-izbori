...
public final class eventGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<ba.nwt.tim3.systemevents.grpc.LogRequest,
      ba.nwt.tim3.systemevents.grpc.APIResponse> getLogMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "log",
      requestType = ba.nwt.tim3.systemevents.grpc.LogRequest.class,
      responseType = ba.nwt.tim3.systemevents.grpc.APIResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ba.nwt.tim3.systemevents.grpc.LogRequest,
      ba.nwt.tim3.systemevents.grpc.APIResponse> getLogMethod() {
    io.grpc.MethodDescriptor<ba.nwt.tim3.systemevents.grpc.LogRequest, ba.nwt.tim3.systemevents.grpc.APIResponse> getLogMethod;
    if ((getLogMethod = eventGrpc.getLogMethod) == null) {
      synchronized (eventGrpc.class) {
        if ((getLogMethod = eventGrpc.getLogMethod) == null) {
          eventGrpc.getLogMethod = getLogMethod = 
              io.grpc.MethodDescriptor.<ba.nwt.tim3.systemevents.grpc.LogRequest, ba.nwt.tim3.systemevents.grpc.APIResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "event", "log"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ba.nwt.tim3.systemevents.grpc.LogRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ba.nwt.tim3.systemevents.grpc.APIResponse.getDefaultInstance()))
  ...
  public static abstract class eventImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void log(ba.nwt.tim3.systemevents.grpc.LogRequest request,
        io.grpc.stub.StreamObserver<ba.nwt.tim3.systemevents.grpc.APIResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ba.nwt.tim3.systemevents.grpc.LogRequest,
                ba.nwt.tim3.systemevents.grpc.APIResponse>(
                  this, METHODID_LOG)))
          .build();
    }
  }
  ...
  public static final class eventBlockingStub extends io.grpc.stub.AbstractStub<eventBlockingStub> {
    ...
    /**
     */
    public ba.nwt.tim3.systemevents.grpc.APIResponse log(ba.nwt.tim3.systemevents.grpc.LogRequest request) {
  ...
  public static final class eventFutureStub extends io.grpc.stub.AbstractStub<eventFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ba.nwt.tim3.systemevents.grpc.APIResponse> log(
        ba.nwt.tim3.systemevents.grpc.LogRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LOG:
          serviceImpl.log((ba.nwt.tim3.systemevents.grpc.LogRequest) request,
              (io.grpc.stub.StreamObserver<ba.nwt.tim3.systemevents.grpc.APIResponse>) responseObserver);
          break;
        default:
